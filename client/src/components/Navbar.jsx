...
// TODO Setup Flowbite tooltip to display nav link name
const Navbar = () => {
  return (
    <div class="fixed bottom-2 z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
